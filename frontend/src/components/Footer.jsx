...
const Footer = () => {
  return (
    <React.Fragment>
      <div className="w-full h-[40vh] flex justify-center items-center bg-[#42A045] shadow-lg p-5">
        <div className="w-[65%] flex flex-col gap-y-10 justify-between items-start p-5">
          <div className="w-full grid grid-cols-3 gap-10">
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              {items.map((item) => (
                <div
                  key={item.id}
                  className="w-64 border-b-[1px] border-gray-200 p-2 hover:bg-teal-700 hover:rounded-lg text-[#F4F4F5]"
                >
            ...
            <div className="flex flex-col items-start justify-start gap-y-3">
              ...
              <div className="flex justify-start gap-x-5 mt-3 items-center">
                ...
                />
                <button className="px-5 py-2 bg-teal-800 rounded-md text-white text-md">
                  Submit
                </button>
              </div>
            </div>
          ...
          <div className="w-full flex justify-between items-center">
            <div className="flex justify-start items-center gap-x-10">
              <Link
                to={"/"}
                className="h-8 w-8 p-1  border-[1px] border-gray-300 flex justify-center items-center rounded-md hover:bg-teal-600"
              >
